  ...
  return (
    <div className="space-y-6">
      ...
      <PortalSurfaceCard className="overflow-hidden max-w-2xl p-0">
        <div className={cn("p-6 sm:p-8 text-white bg-gradient-to-br border-b border-primary/20", gradient)}>
          <div className="flex items-center gap-4">
            <div className="h-16 w-16 rounded-2xl bg-primary/15 backdrop-blur flex items-center justify-center text-2xl font-bold border border-primary/30 text-primary">
              {user.name
                .split(" ")
                .map((n) => n[0])
                .join("")
