...
function friendlyValidationMessage(issue: z.ZodIssue | undefined): string {
  ...
  if (field === "program") return "Please select a valid program.";
    ...
    if (!REGISTRATION_OPEN) {
      return NextResponse.json(
        createApiResponse(false, {
          ...
          message: "Registration is currently closed for the 3rd module. Please wait for the next announcement.",
        }),
        { status: 400 }
      );
    }
