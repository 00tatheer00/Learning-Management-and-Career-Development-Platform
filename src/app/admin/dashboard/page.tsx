    ...
    <div>
        ...
        <div className="rounded-2xl border-2 border-amber-300 bg-amber-50 p-5 mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-amber-800">
              Check payment screenshot and approve or reject.
            </p>
          </div>
          <Button size="lg" asChild>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <QuickActionCard
          ...
          title="Registrations"
          description="Approve new student applications"
        ...
        <QuickActionCard
          ...
          title="Portal Logins"
          description="Student login IDs and passwords"
        ...
        <QuickActionCard
          href="/admin/trainers"
          title="Trainers"
          description="View trainer accounts"
