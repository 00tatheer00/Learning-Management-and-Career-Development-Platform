...
export const PORTAL_NAV: Record<UserRole, PortalNavItem[]> = {
  ...
  trainer: [
    ...
    { href: "/trainer/recordings", label: "Class Recordings", icon: FilmStrip, description: "Google Drive & Bunny Stream video uploads" },
  ...
  admin: [
    ...
    { href: "/admin/recordings", label: "Recordings", icon: FilmStrip, description: "Bunny Stream video recordings" },
...
export const STUDENT_PAGE_TITLES: Record<string, string> = {
  ...
  "/student/recordings": "HD Recordings",
  "/student/recordings/drive": "Drive Recordings",
  "/student/drive-recordings": "Drive Recordings",
