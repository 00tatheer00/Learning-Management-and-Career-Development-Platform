...
export const trainers: Trainer[] = [
  ...
  },
  {
    ...
    featured: true,
    expertise: ["Flutter", "Dart", "Firebase", "API", "Provider", "GetX", "Mobile UI"],
    experience: "4+ years",
  ...
  },
  {
    ...
    image: "/trainers/zunira-rehman.png",
    imagePosition: "center 20%",
    social: {},
  },
  {
    ...
    programSlug: "web-development",
    featured: true,
    expertise: ["HTML", "CSS", "JavaScript", "PHP", "Laravel", "MySQL", "React", "Responsive UI"],
    experience: "3+ years",
  ...
  },
  {
    ...
    programSlug: "app-development",
    expertise: ["Flutter", "Dart", "State Mgmt.", "Firebase", "API", "Git", "App Deployment"],
    experience: "3+ years",
  ...
  },
  {
    id: "trainer-usman",
    name: "M Usman",
    designation: "Ecommerce Trainer",
    programSlug: "ecommerce",
    featured: true,
    expertise: ["Ecommerce", "Shopify", "WooCommerce", "Product Management", "Digital Marketing", "Sales"],
    experience: "3+ years",
    bio: "Guides students through building, managing, and scaling online stores with real-world ecommerce strategies and tools.",
    social: {},
  },
  {
    id: "trainer-fazal",
    ...
    featured: true,
    expertise: ["Photoshop", "Illustrator", "Branding", "Visual Design", "Social Media Graphics"],
    experience: "3+ years",
