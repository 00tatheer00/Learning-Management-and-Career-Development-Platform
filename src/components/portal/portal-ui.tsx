...
const accentStyles = {
  rose: {
    ...
    text: "text-rose-950 dark:text-rose-100 font-black opacity-100",
    label: "text-rose-900/80 dark:text-rose-200/80 font-bold uppercase tracking-wider opacity-80",
  ...
  orange: {
    ...
    text: "text-amber-950 dark:text-amber-100 font-black opacity-100",
    label: "text-amber-900/80 dark:text-amber-200/80 font-bold uppercase tracking-wider opacity-80",
  ...
  green: {
    ...
    text: "text-emerald-950 dark:text-emerald-100 font-black opacity-100",
    label: "text-emerald-900/80 dark:text-emerald-200/80 font-bold uppercase tracking-wider opacity-80",
  ...
  blue: {
    ...
    text: "text-indigo-950 dark:text-indigo-100 font-black opacity-100",
    label: "text-indigo-900/80 dark:text-indigo-200/80 font-bold uppercase tracking-wider opacity-80",
  ...
  sky: {
    ...
    text: "text-sky-950 dark:text-sky-100 font-black opacity-100",
    label: "text-sky-900/80 dark:text-sky-200/80 font-bold uppercase tracking-wider opacity-80",
  ...
  slate: {
    ...
    text: "text-slate-950 dark:text-slate-100 font-black opacity-100",
    label: "text-slate-800/80 dark:text-slate-200/80 font-bold uppercase tracking-wider opacity-80",
    ...
    <>
      <div className={cn("flex items-start gap-2.5", !icon && "block")}>
        ...
        <div className="min-w-0">
          ...
          <p className={cn("tabular-nums truncate font-black opacity-100", compact ? "text-2.5xl mt-0.5" : "text-4xl mt-0.5", style.text)}>
            {value}
          </p>
        </div>
      </div>
      {hint && (
        <p className={cn("font-bold text-slate-700/80 dark:text-slate-300/80 opacity-80", compact ? "text-[10px] mt-1.5" : "text-xs mt-2")}>{hint}</p>
      )}
    </>
  );
