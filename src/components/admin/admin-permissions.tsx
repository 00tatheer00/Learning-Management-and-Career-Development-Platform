...
import { canAdminWrite, isAdminRole } from "@/lib/auth/admin-access";
...
export function AdminReadOnlyBanner() {
  ...
  return (
    <div className="mb-4 rounded-xl border border-amber-200/90 bg-amber-50 px-4 py-3 text-sm text-amber-950">
