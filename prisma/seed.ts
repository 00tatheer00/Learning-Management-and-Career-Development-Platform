...
const DEFAULT_USERS = [
  {
    ...
    password: seedPassword("SEED_ADMIN_PASSWORD", "TatheerisAdmin@321"),
    role: "admin" as const,
  ...
  },
  {
    ...
    password: seedPassword("SEED_TRAINER_USMAN_PASSWORD", "usman@321"),
    role: "trainer" as const,
    name: "M Usman",
    phone: "03000000000",
  ...
  },
  {
    ...
    password: seedPassword("SEED_TRAINER_FAISAL_PASSWORD", "faisal@321"),
    role: "trainer" as const,
    name: "Faisal Habib",
    phone: "03000000000",
  ...
  },
  {
    ...
    name: "Demo Student",
    phone: process.env.DEMO_STUDENT_WHATSAPP?.trim() || "03115969527",
    programSlug: "web-development",
    level: "HTML & CSS",
    batch: "Batch 1",
    avatarInitials: "DS",
  ...
  for (const [index, level] of modules.entries()) {
    ...
    await prisma.enrollment.upsert({
      ...
      create: {
        ...
        whatsapp: process.env.DEMO_STUDENT_WHATSAPP?.trim() || "03115969527",
